...
import com.example.notate.data.CanvasData
import com.example.notate.databinding.ActivityMainBinding
import com.example.notate.export.CanvasExportCoordinator
...
import com.example.notate.ui.SettingsSidebarController
import com.example.notate.ui.SidebarCoordinator
import com.example.notate.ui.ToolbarCoordinator
import com.example.notate.ui.dpToPx
import com.example.notate.ui.export.ExportAction
import com.example.notate.util.ThumbnailGenerator
import com.example.notate.vm.DrawingViewModel
...
class CanvasActivity : AppCompatActivity() {
    ...
    private var activePenPopup: com.example.notate.ui.dialog.PenSettingsPopup? = null
            ...
            try {
                ...
                if (!jsonString.isNullOrEmpty()) {
                    ...
                    withContext(Dispatchers.Main) {
                        ...
                        isFixedPageState?.value = data.canvasType == com.example.notate.data.CanvasType.FIXED_PAGES
        ...
        if (isFixedPageState?.value == true) {
            ...
            val composeView =
                androidx.compose.ui.platform.ComposeView(this).apply {
                    ...
                    setContent {
                        com.example.notate.ui.navigation.CompactPageNavigation(
    ...
    private fun handleToolClick(
        ...
        if (viewModel.activeToolId.value == toolId) {
            ...
            val popup =
                com.example.notate.ui.dialog.PenSettingsPopup(
                    this,
                    tool,
