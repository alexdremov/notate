...
import com.example.notate.databinding.DialogPenSettingsBinding
import com.example.notate.databinding.ItemColorCircleBinding
...
import com.example.notate.ui.pxToMm
import com.example.notate.util.ColorUtils
...
class PenSettingsPopup(
    ...
    private fun refreshHighQuality(view: View) {
        ...
        com.example.notate.util.EpdFastModeController
            .exitFastMode()
        view.post {
    ...
    private fun setupMainUI() {
        ...
        if (currentTool.type == com.example.notate.model.ToolType.ERASER) {
            setupEraserUI()
        } else {
            setupPenUI()
        }
        ...
        val maxMm = if (currentTool.type == com.example.notate.model.ToolType.ERASER) 50f else currentTool.strokeType.maxWidthMm
    ...
    private fun setupEraserUI() {
        ...
        when (currentTool.eraserType) {
            com.example.notate.model.EraserType.STANDARD -> binding.rbEraserStandard.isChecked = true
            com.example.notate.model.EraserType.STROKE -> binding.rbEraserStroke.isChecked = true
            com.example.notate.model.EraserType.LASSO -> binding.rbEraserLasso.isChecked = true
        }
        ...
        binding.rgEraserTypes.setOnCheckedChangeListener { _, checkedId ->
            val type =
                when (checkedId) {
                    R.id.rbEraserStandard -> com.example.notate.model.EraserType.STANDARD
                    R.id.rbEraserStroke -> com.example.notate.model.EraserType.STROKE
                    R.id.rbEraserLasso -> com.example.notate.model.EraserType.LASSO
                    else -> com.example.notate.model.EraserType.STANDARD
                }
    ...
    private fun updateWidthSliderVisibility(eraserType: com.example.notate.model.EraserType) {
        val isLasso = eraserType == com.example.notate.model.EraserType.LASSO
