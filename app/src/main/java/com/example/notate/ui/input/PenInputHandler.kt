...
import com.example.notate.controller.CanvasController
import com.example.notate.model.EraserType
...
import com.example.notate.util.ShapeRecognizer
...
class PenInputHandler(
    ...
    private var cursorView: com.example.notate.ui.CursorView? = null
    ...
    fun setCursorView(view: com.example.notate.ui.CursorView) {
                ...
                if (isCurrentStrokeEraser || currentTool.type == ToolType.ERASER || b) {
                    ...
                    val isScribble =
                        originalStroke != null &&
                            ...
                            com.example.notate.data.PreferencesManager
                                .isScribbleToEraseEnabled(view.context) &&
                            com.example.notate.util.ScribbleDetector
                    ...
                    if (isScribble) {
                        ...
                        if (shapeEnabled && originalStroke != null && result != null &&
                            ...
                            for (segmentPoints in result.segments) {
                                ...
                                val perfectedStroke =
                                    com.example.notate.model.Stroke(
                                        path = segmentPath,
                                        ...
                                        bounds =
                                            com.example.notate.util.StrokeGeometry.computeStrokeBounds(
                                                segmentPath,
                                                currentTool.width,
                                                currentTool.strokeType,
                                            ),
