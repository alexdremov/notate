package com.example.notate.controller
...
class CanvasControllerImpl(
    ...
    private var viewportController: com.example.notate.controller.ViewportController? = null

    override fun setViewportController(controller: com.example.notate.controller.ViewportController) {
    ...
    override fun getCurrentPageIndex(): Int {
        ...
        val pageFullHeight = model.pageHeight + com.example.notate.config.CanvasConfig.PAGE_SPACING
        return kotlin.math
